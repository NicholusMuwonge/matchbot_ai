...
class RoleAssignmentService:
    ...
    def determine_user_role(self, user_data: dict) -> Optional[Role]:
        """
    ...
    async def assign_initial_role(self, user: User, user_data: dict) -> dict:
        ...
        try:
            ...
            logger.info(f"Assigned {role.name} role to user {user.email or user.clerk_user_id}")
    ...
    def get_primary_email(self, user_data: dict) -> Optional[str]:
        """
