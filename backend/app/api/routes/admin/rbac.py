...
from app.api.deps import AdminUser, AppOwnerUser, SessionDep
...
async def assign_role_to_user(
    request: UserRoleAssignRequest, session: SessionDep, _: AppOwnerUser
) -> UserRoleResponse:
    """
...
async def remove_role_from_user(
    user_id: UUID, role_name: str, session: SessionDep, _: AppOwnerUser
) -> UserRoleResponse:
    """
...
async def get_user_roles(
    user_id: UUID, session: SessionDep, _: AdminUser
